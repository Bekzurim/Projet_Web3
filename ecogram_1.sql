...
--
-- Hôte : 127.0.0.1
-- Généré le :  lun. 20 avr. 2020 à 15:53
...
CREATE TABLE `Actualite` (
  ...
  `likeA` int(255) NOT NULL DEFAULT '0',
  `dislikeA` int(255) NOT NULL DEFAULT '0',
...
INSERT INTO `Actualite` (`id_actualite`, `dateA`, `heureA`, `contenue`, `likeA`, `dislikeA`, `id_annonceur`) VALUES
(1, '2020-04-19', '15:00:00', 'La mairie de Paris a annocé la fermeture définitive d\'un parc ! Où vont allez tous ces pauvres petit lapin?!', 10, 2, 5),
(2, '2020-04-19', '15:02:00', 'Finallement j\'avais mal compris ! Il vont agrandir le parc! Ouf sauver !', 30, 6, 5),
(3, '2020-04-19', '18:05:54', 'Je participe a la marche organiser par ma ville ! Hâte d\'y être !', 0, 0, 4),
(4, '2020-04-19', '20:00:00', 'L’événement de la semaine dernière était vraiment mal organiser... C\'est une honte !\r\n#OnNousMent', 2, 10, 3),
(5, '2020-04-19', '15:01:00', 'Renseigner vous avant de dire des bêtises !', 0, 0, 2);
